...
The AJAX call will be done to a URL with this format: https://geocode.xyz/52.508,13.381?geoit=json. Use the fetch API and promises
 to get the data. Do NOT use the getJSON function we created, that is cheating 😉
...
//   fetch(`https://geocode.xyz/${lat},${lon}?geoit=json&auth=645697531954568548632x24006`)
//   .then(response => response.json())
//   .then(response => {
//     console.log(response);
//     return response;
//   })
//   .then(response => console.log(`Vous êtes dans ${response.city},${response.country}`))
// }

// whereAmI(19.037,72.873);
// whereAmI(50.0809224,5.703622);
