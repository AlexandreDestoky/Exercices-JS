...
a dog is an adult or a puppy. A dog is an adult if it is at least 3 years old, and it's a puppy if it's less 
than 3 years old.
...
shallow copy of Julia's array, and remove the cat ages from that copied array (because it's a bad practice 
...
const checkDogs = function (tabJ, tabK) {
  let tabJcorrige = [...tabJ].splice(1, tabJ.length - 3);
  let tabTotal = [...tabJcorrige, ...tabK];
  tabTotal.forEach(function (age, i) {
